...
(function initLightbox() {
    ...
    var excludeSelectors = '.logo, .navbar, .nav-container, .footer, .hero-logo, .lightbox-overlay, .cookie-banner, .partners-grid, .highlight-actu-image, .actualite-asso-image, .carousel-card-image';
